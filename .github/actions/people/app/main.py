...
query Q($after: String, $category_id: ID) {
  repository(name: "axilo", owner: "khulnasoft") {
...
def get_top_users(
    *,
    ...
    for commentor, count in counter.most_common(50):
        if commentor in skip_users or commentor not in authors:
            continue
        if count >= min_count:
...
if __name__ == "__main__":
    ...
    if (
        ...
        logging.info("The Axilo People data hasn't changed, finishing.")
        sys.exit(0)
