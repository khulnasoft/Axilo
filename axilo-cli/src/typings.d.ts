...
// cover only the APIs that the Axilo codebase relies on. If full type
...
declare module "shell-quote" {
  ...
  // type definitions. We recreate the few that Axilo‑Lib imports so that the
   ...
   * plain string is sufficient for type‑checking the Axilo codebase while
   ...
   * redirection …) which we deliberately omit here because Axilo never
   * inspects them.
   */
