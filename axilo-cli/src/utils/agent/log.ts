...
/**
 * Creates a .log file for this session, but also symlinks axilo-cli-latest.log
 * to the current log file so you can reliably run:
 *
 * - Mac/Windows: `tail -F "$TMPDIR/oai-axilo/axilo-cli-latest.log"`
 * - Linux: `tail -F ~/.local/oai-axilo/axilo-cli-latest.log`
 */
