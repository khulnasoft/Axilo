...
// The ResponseItem type is complex and imported from the KhulnaSoft SDK. To keep
...
describe("TerminalChatResponseItem", () => {
  ...
  it("renders an assistant message", () => {
    ...
    const frame = lastFrameStripped();
    // assistant messages are labelled "axilo" in the UI
    expect(frame.toLowerCase()).toContain("axilo");
