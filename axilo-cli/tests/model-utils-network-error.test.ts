...
// The model‑utils module reads KHULNASOFT_API_KEY at import time. We therefore
...
// Holders so individual tests can adjust behaviour of the KhulnaSoft mock.
...
describe("model-utils – offline resilience", () => {
  ...
  it("falls back gracefully when openai.models.list throws a network error", async () => {
    process.env["KHULNASOFT_API_KEY"] = "dummy";
