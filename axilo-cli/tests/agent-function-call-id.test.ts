...
// error from the KhulnaSoft API.
// ---------------------------------------------------------------------------

// Fake KhulnaSoft stream that immediately yields a *chat‑style* function_call item.
class FakeStream {
...
// We intercept the KhulnaSoft SDK so we can inspect the body of the second call –
