...
// Fake stream returned from the mocked KhulnaSoft SDK. The AgentLoop only cares
...
describe("AgentLoop", () => {
  it("passes axilo.md contents through the instructions parameter", async () => {
    ...
    // Kick off a single run and wait for it to finish. The fake KhulnaSoft client
    ...
    // loadConfig → AgentLoop → addInstructionPrefix → KhulnaSoft SDK.
