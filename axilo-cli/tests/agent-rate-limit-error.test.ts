...
// ---------------------------------------------------------------------------
//  Utility: fake KhulnaSoft SDK with programmable behaviour per test case.
// ---------------------------------------------------------------------------
...
describe("AgentLoop – KhulnaSoft rate limit errors", () => {
  it("surfaces a user‑friendly system message instead of throwing on RateLimitError (TDD – expected to fail)", async () => {
    // Arrange fake KhulnaSoft: every call fails with a rate‑limit error.
