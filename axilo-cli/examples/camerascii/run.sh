...
# run.sh — Create a new run_N directory for a Axilo task, optionally bootstrapped from a template,
# then launch Axilo with the task description from task.yaml.
#
# Usage:
